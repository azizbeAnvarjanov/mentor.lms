...
export default function ChapterPPTUploader({ chapterId }) {
  ...
  const handleUpload = async () => {
    ...
    const filePath = `ppt/${chapterId}/${file.name}`;
  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <h1 className="font-medium text-xl">Prezentatsiyalar</h1>

        <div className="flex items-center gap-1 ">
          <Button
            onClick={() => setOpen(true)}
            className="bg-muted mr-2 text-black border dark:text-white hover:bg-muted"
          >
            <CircleFadingPlus />
            Yuklash 
          </Button>
